...
import { IAZService } from "../services/IAZService";
import { IAZProperties } from "../utils/SPConstants";
import { AZBaseService } from "./_AZBaseService";

export class AZService extends AZBaseService implements IAZService {
     ...
     */
    public ObtenerMteWpProcesoComprasPorID = (empresaID: number) => new Promise<JSON>(async (resolve, reject) => { 
        try {
            const { 
                ResourceId, 
